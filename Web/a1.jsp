...
<html lang="en">
<head>
<title>itp_gopeshwar.com/loginuser/</title>
	...
	<div class="header-top">
		<div class="container">
			<div class="w3layouts-address">
				<ul>
					<li><i class="fa fa-mobile" aria-hidden="true"></i>contact: 9958713527,9315142099</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="skhan.javaexpert@gmail.com">thdcihet@gmail.com</a></li>
				</ul>
			</div>
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="w3layouts-logo">
							<h1><a href="index.html">THDC-IHET<span>Uttarakhand</span></a></h1>
						</div>
					</div>

...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/thdc","root","");
String query="insert into STUD_FEEDBACK (PROGNAME,SEM,S1,A1,name,OPTREADIO1,OPTRADIO2,OPTRADIO3,OPTRADIO4,OPTRADIO5,OPTRADIO6,OPTRADIO7,OPTRADIO8,id) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
